...
from database import Base,Holder,Company
...
def get_company_holders(soup,company,company_name):
    # 获取网页中股东部分
...
def download_company(company_name):
    ...
    # 获取公司基本信息
    try:
        company = get_company_info(soup,company_name)
