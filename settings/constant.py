...
# 存货类科目
inventory = ["原材料", "包装物", "低值易耗品", "库存商品", "委托加工物资", "周转材料", "材料采购", "物资采购","材料采购", "包装物及低值易耗品", "产成品", "主营业务成本"]
# 存货类科目包含税费
inventory_tax = ["原材料", "包装物", "低值易耗品", "库存商品", "委托加工物资", "周转材料", "材料采购", "物资采购","材料采购", "包装物及低值易耗品", "产成品", "主营业务成本","应交税费"]
# 长期资产类科目
...
tax_payable = {"应交个人所得税":"个人所得税","应交土地使用税":"土地使用税","应交堤围费":"堤围费","应交堤围防护费":"堤围费",
               ...
               "转出未交增值税":"增值税-转出未交增值税","减免税款":"增值税-见面税款","出口退税":"增值税-出口退税",
